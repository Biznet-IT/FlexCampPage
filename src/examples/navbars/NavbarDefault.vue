...
<template>
  ...
  ]" :to="{ name: 'presentation' }" rel="tooltip" title="By Biznet It" data-placement="bottom">
        FlexCamp
      </RouterLink>
      <RouterLink class="navbar-brand d-block d-md-none" :class="props.transparent || props.dark
      ? 'text-white'
      : 'font-weight-bolder ms-sm-3'
    " to="/" rel="tooltip" title="By Biznet It" data-placement="bottom">
        FlexCamp
      </RouterLink>
                  ...
                  <div class="row">
                    <div class="position-relative">
                      ...
                      <RouterLink :to="{ name: 'about' }" class="dropdown-item border-radius-md">
                        <span>Acerca de FlexCamp</span>
                      </RouterLink>
                      <RouterLink :to="{ name: 'description' }" class="dropdown-item border-radius-md">
